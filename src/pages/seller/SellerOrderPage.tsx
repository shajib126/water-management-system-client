...
import { useAllOrdersSellerQuery, useEditOrderSellerMutation } from "../../redux/api/baseApi"
...
const SellerOrderPage = () => {
    const {isLoading,data} = useAllOrdersSellerQuery('')
    const [editOrderSeller] = useEditOrderSellerMutation()
    ...
    const handleSaveChange = async(order:any)=>{
        ...
        if(editOption == 'delevery'){
          ...
          const res = await editOrderSeller({params,orderInfo})
